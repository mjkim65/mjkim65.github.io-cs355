...
const backpackList = backpackObjectArray.map((backpack) => {
  let bpArticle = document.createElement("article");
  bpArticle.classList.add("backpack");
  bpArticle.setAttribute("id", backpack.id);
  ...
  let length = bpArticle.querySelectorAll(".backpack__strap");
  newStrapLength(length);
  let button = bpArticle.querySelector(".lid-toggle");
